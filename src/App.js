...
import WeatherHistory from './hooks/WeatherHistory';
...
function App() {
  ...
  const onSubmitButtonClicked = () => {
    ...
    setStorage(cityInput); // Make sure this line is correctly calling setStorage
  };
  ...
  return (
    <div class="container">
      ...
      <div id="weatherInfoComponent" style={{ display: "flex" }}></div>
    </div>
  );
}
